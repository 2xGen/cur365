        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-4 text-lg text-slate-600 leading-relaxed">
              Run a Klein Curaçao day trip, yacht, powerboat or private charter and want it featured on Cur365? We’d love to hear from you.
            </p>

            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10">
              <a
                href="mailto:matthijs@2xgen.com"
                className="inline-flex items-center gap-3 px-6 py-4 rounded-xl bg-slate-100 hover:bg-cur-blue/10 text-slate-800 hover:text-cur-blue font-medium transition-colors border border-slate-200 hover:border-cur-blue/30"
              >
            ...
            <p className="mt-8 text-slate-500 text-sm">
              Reach out to feature your Klein Curaçao tours on Cur365. We’ll get back to you as soon as we can.
            </p>
