  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-cur-blue">Launching</span> Soon
        </h2>
        <p className="text-slate-600 text-center max-w-2xl mx-auto mb-10">
          We’re currently finalizing Klein Curaçao category pages, comparison guides, and booking cards. Cur365 is built to be the focused place for:
        </p>
        ...
        <p className="font-display font-semibold text-slate-800 text-center text-lg mb-8" style={{ fontFamily: "var(--font-display), system-ui, sans-serif" }}>
          Everything Klein Curaçao. 365 Days a Year.
        </p>
        <p className="text-slate-500 text-center text-sm mb-4">Questions? Get in touch.</p>
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="mailto:matthijs@2xgen.com"
            className="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-medium text-white bg-cur-coral hover:bg-cur-coral-dark btn-lift shadow-md"
          >
